...
from numpy import (array,dot,diag,sqrt,diff,newaxis,zeros,exp,angle,sin,cos,
  ndarray,vstack,hstack,real,var,floor,ones,reshape,conj,unwrap,ceil,isinf,
  linspace,pi,sum)
...
import warnings
#from matplotlib.mlab import find # WARNING DEPRECATED
from numpy import nonzero as find
...
def test_sincos():
  ...
  from pylab import plot, legend, axis, show, randint, randn, lstsq
